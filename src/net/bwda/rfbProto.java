...
class rfbProto {
	...
	static  int NoAuth = 1;
	static	int VncAuth = 2;
	final int VncAuthOK = 0;
	static int VncAuthFailed = 1;
	static int VncAuthTooMany = 2;

	static  int FramebufferUpdate = 0;
	static int SetColourMapEntries = 1;
	static int Bell = 2;
	static int ServerCutText = 3;

	final int SetPixelFormat = 0;
	static int FixColourMapEntries = 1;
	static int SetEncodings = 2;
	static int FramebufferUpdateRequest = 3;
	static int KeyEvent = 4;
	static int PointerEvent = 5;
	static int ClientCutText = 6;

	 static int EncodingRaw = 0;
	static int EncodingCopyRect = 1;
	static int EncodingRRE = 2;
	static int EncodingCoRRE = 4;
	static int EncodingHextile = 5;
